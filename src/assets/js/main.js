...
(function($) {
    ...
    $(".swiper-group-2-style-2").each(function() {
        var swiper_2_items = new Swiper(this, {
            ...
            loop: true,
            navigation: {
                nextEl: ".swiper-button-next-Ecommerce",
                prevEl: ".swiper-button-prev-Ecommerce"
            },
            pagination: {
                el: '.swiper-pagination',
                clickable: true
...
$('.sub-menu a').on('click', function(event) {
    if ($(this).next().hasClass('in')) {
        ...
        $(this).parents('.open').find('.collapse').collapse('hide');
        $(this).next().collapse('show');
    }
})
...
function initMap() {
    ...
    var uluru = { lat: 40.7583709, lng: -73.9720135 };
